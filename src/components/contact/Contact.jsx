export default function Contact() {
   return (
      <div className="max-w-6xl flex h-screen items-top justify-center mx-auto sm:px-6 lg:px-8 my-16">
         <div className="flex flex-col sm:flex-row h-72">
            <div className="sm:p-6 p-1 sm:mr-2  bg-gray-100 sm:rounded-xl">
               <h1 className="text-xl sm:text-4xl text-gray-800 font-extrabold tracking-tight">
                  Get in touch:
               </h1>
               ...
               <div className="flex items-center mt-8 text-gray-600">
                  ...
                  <div className="ml-4 text-md font-semibold w-40">
                     Bookstore, Street, State, Postal Code
                  </div>
               </div>
